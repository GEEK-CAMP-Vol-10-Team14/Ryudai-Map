...
const CurrentLocationMarker = () => {
  ...
  return position ? <Marker position={position} icon={GPSIcon}></Marker> : null;
};

export const Map = () => {
  // 緯度軽度
  const position = [26.25259, 127.766111];
  ...
  const yongou_hanbaiki = [26.2526, 127.76771];
  const kitasyoku_hanbaiki_iti = [26.2517, 127.76581];
  ...
  return (
    ...
    >
      ...
      <Marker position={one}>
        <Popup>
          工学部1号館<br></br>
          <a href="./BuildingOne" rel="noopener noreferrer">
            詳細
          </a>
        </Popup>
      </Marker>
      ...
      <Marker position={two}>
        <Popup>
          工学部2号館<br></br>
          <a href="./BuildingTwo" rel="noopener noreferrer">
            詳細
          </a>
        </Popup>
      </Marker>
      ...
      <Marker position={three}>
        <Popup>
          工学部3号館<br></br>
          <a href="./BuildingThree" rel="noopener noreferrer">
            詳細
          </a>
        </Popup>
      </Marker>
      ...
      <Marker position={four}>
        <Popup>
          工学部4号館<br></br>
          <a href="./BuildingFour" rel="noopener noreferrer">
            詳細
          </a>
        </Popup>
      </Marker>
      ...
      <Marker position={tisou}>
        <Popup>
          琉球大学地域創生総合研究棟<br></br>
          <a href="./BuildingTisoto" rel="noopener noreferrer">
            詳細
          </a>
        </Popup>
      </Marker>
      ...
      <Marker position={kitasyoku}>
        <Popup>
          北食堂<br></br>
          <a href="./BuildingKitaShokudou" rel="noopener noreferrer">
            詳細
          </a>
        </Popup>
      </Marker>
